...
const Kesehatan = () => {
  ...
  // api url
  const API_URL = import.meta.env.VITE_API_URL_KESEHATAN;
    ...
    <div>
      <div className="w-full">
        ...
        <div className="flex flex-col justify-center p-10 lg:mt-20 md:mt-16 mt-10">
          <h1 className="text-center lg:text-4xl md:text-3xl text-2xl">Berita Kesehatan</h1>
          <button className="text-center bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded my-4 max-w-md mx-auto" onClick={() => setIsFormVisible(true)}>
        ...
        <div className="bg-white">
          <div className="flex flex-wrap justify-center">
            {data.length > 0 ? (
              data.map((item) => (
                <div key={item._id} className="flex flex-col gap-4 p-4 border w-[500px] rounded-2xl hover:bg-gray-100 m-4 relative shadow-md">
                  {item.imageUrl && (
